...
# ==========================================
# 0. CONFIGURACIÓN RED UDP (GEMELO DIGITAL -> NOC)
# ==========================================
UDP_IP = "127.0.0.1"
UDP_PUERTO = 5005
    ...
    while driver.step() != -1:
        ...
        if cmd:
            ...
            if tipo_comando == "GOTO":
                ...
                print(f"[ALERTA NOC] Orden de bloqueo recibida: Nodo {target_nodo}.")
                print(f"Protocolo activado: El Agente Edge ignora el apagado ciego.")
                print(f"El Agente mantendrá su ruta óptima y auditará físicamente el entorno con YOLOv8.")
        ...
        if imagen_cruda is not None:
            ...
            cv2.imshow("Dashcam IA - NOC", imagen_ampliada)
            cv2.waitKey(1)
